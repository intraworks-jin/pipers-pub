! function() {
    ...
    var e = {
        ...
        a = function() {
            var e = 0;
            jQuery(".canarystrap-animate").waypoint(function(t) {
                "down" !== t || jQuery(this.element).hasClass("canarystrap-animated") || (e++, jQuery(this.element).addClass("item-animate"), setTimeout(function() {
                    jQuery("body .canarystrap-animate.item-animate").each(function(e) {
                        var t = jQuery(this);
                        setTimeout(function() {
                            var e = t.data("animate-effect");
                            "fadeIn" === e ? t.addClass("fadeIn canarystrap-animated") : "fadeInLeft" === e ? t.addClass("fadeInLeft canarystrap-animated") : "fadeInRight" === e ? t.addClass("fadeInRight canarystrap-animated") : t.addClass("fadeInUp canarystrap-animated"), t.removeClass("item-animate")
                        }, 30 * e, "easeInOutExpo")
                    })
                }, 100))
            }, {
        ...
        i = function() {
            jQuery(window).scroll(function() {
                jQuery(this).scrollTop() > 5 ? jQuery(".canarystrap-navbar").addClass("scrolled") : jQuery(".canarystrap-navbar").removeClass("scrolled")
            })
        },
        r = function(e) {
    ...
    jQuery(function() {
        a(), i(), jQuery(".canarystrap-gallery").length > 0 && r(".canarystrap-gallery"), o(), s(), l(), c()
